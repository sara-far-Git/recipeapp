  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        lift: "0 24px 60px -28px rgba(58, 38, 24, 0.34)",
        glow: "0 0 0 4px rgba(139, 58, 31, 0.16)",
        "glow-lg": "0 0 0 6px rgba(139, 58, 31, 0.20)",
        "glow-sm": "0 0 0 3px rgba(139, 58, 31, 0.14)",
      ...
      fontFamily: {
        ...
        body:    ["'Assistant'", "'Heebo'", "-apple-system", "sans-serif"],
        serif:   ["'Assistant'", "'Heebo'", "sans-serif"],
      },
      letterSpacing: {
        display: "-0.045em",
        label: "0.12em",
      ...
      keyframes: {
        ...
        pulseGlow: { "0%, 100%": { boxShadow: "0 0 0 0 rgba(139, 58, 31, 0.30)" }, "50%": { boxShadow: "0 0 0 10px rgba(139, 58, 31, 0)" } },
        float:     { "0%, 100%": { transform: "translateY(0px)" }, "50%": { transform: "translateY(-10px)" } },
        marquee:   { "0%": { transform: "translateX(0)" }, "100%": { transform: "translateX(-50%)" } },
        nudge:     { "0%, 100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(6px)" } },
      },
    },
  },
  plugins: [],
