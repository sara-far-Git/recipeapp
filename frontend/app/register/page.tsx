    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8 animate-fade-up">
          ...
          <h1 className="font-display text-3xl font-bold text-gray-100">הצטרפו לקהילה</h1>
        ...
        <p className="text-center text-sm text-smoke-400 mt-6 animate-fade-up" style={{ animationDelay: "250ms" }}>
          כבר יש לך חשבון? <Link href="/login" className="text-fire-300 font-bold hover:text-fire-200 transition-colors">התחברות</Link>
        </p>
      </div>
    </div>
  );
