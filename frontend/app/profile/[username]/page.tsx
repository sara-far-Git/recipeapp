...
function ProfilePageContent() {
  ...
  className={cn("px-5 py-2  text-sm font-semibold transition-all",
  ...
  <div className="flex items-center gap-1.5 px-3 py-1.5  bg-surface-100 border border-surface-300">
